...
npm run build:mac    # macOS DMG + ZIP (requires macOS; builds are unsigned)
npm run build:linux  # Linux AppImage
npm run build        # All platforms (cross-compile where possible)
```

**Output locations:**
- Windows: `dist/AI-Usage-Monitor-{version}-win-Setup.exe` & `-portable.exe`
- macOS: `dist/AI-Usage-Monitor-{version}-macOS-{arch}.dmg`
- Linux: `dist/AI-Usage-Monitor-{version}-linux-{arch}.AppImage`
...
- Open a [Discussion](https://github.com/banuca/ai-usage-monitor/discussions)
- Check existing [Issues](https://github.com/banuca/ai-usage-monitor/issues)
